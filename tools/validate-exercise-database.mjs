...
if(reviewedExercises.length!==21||productionExerciseLibrary.length<500){ console.error(`ERROR catalogue_count: expected 21 editorial foundations and at least 500 production exercises, received ${reviewedExercises.length} and ${productionExerciseLibrary.length}`); process.exitCode=1; }
