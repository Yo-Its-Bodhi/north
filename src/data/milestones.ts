...
const achievementTracks: AchievementTrack[] = [
  ...
  { track: "personal-records", title: "Personal bests", description: "Beat a previous load {target} times.", category: "Personal best", metric: "personalRecords", targets: [1, 3, 8, 15, 30, 50, 80, 120, 180, 250] },
