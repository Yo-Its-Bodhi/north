...
function validateProposal(input){
  ...
  if(["create_workout","adjust_plan_day"].includes(actionType))payload.saveToMyWorkouts=payload.saveToMyWorkouts===true;
